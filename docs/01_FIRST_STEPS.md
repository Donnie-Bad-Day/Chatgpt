...
3. Upload `scripts/colab_tesseract_ocr.py` into Colab Files panel.
4. Run command in a Colab code cell: `!python colab_tesseract_ocr.py`
5. Upload PDFs/images when prompted.
6. Download OCR outputs (TXT and CSV zip files).
